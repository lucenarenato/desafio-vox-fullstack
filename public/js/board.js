                ...
                function () {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            swal(
                              "Excluído!",
                                "Excluído com sucesso para sempre!",
                                "success"
                            );
                        },
                        error: function (error) {
                            var response = JSON.parse(error.responseText);
                            swal("Ah", "Claro. Verifique a conexão!", "erro");
                        },
                    });
                }
            );
                    ...
                    $(that.params["createBoardLink"])
                        ...
                        .before(
                            '<div class="col-lg-3">' +
                                ...
                                '<a href="http://localhost/board?id=' +
                                data.id +
