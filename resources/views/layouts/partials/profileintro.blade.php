		...
		<div class="media">
			<div class="col-lg-offset-4">
				...
				<div class="media-body" style="padding-left: 20px;">
					...
					<p><span class="glyphicon glyphicon-time" aria-hidden="true"></span>Membro de {{ (Carbon\Carbon::parse(Auth::user()->created_at)) }}</p>
					<p><span class="glyphicon glyphicon-time" aria-hidden="true"></span>Membro de {{ verta(Carbon\Carbon::parse(Auth::user()->created_at)) }}</p>
				</div>
			</div>
		</div>
	</div>
