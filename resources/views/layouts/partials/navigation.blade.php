...
<div class="col-xs-7 col-sm-3 col-md-3 frame sidebar sidebar-right sidebar-animate" style="padding: 0px; background-color: #fff; border-right: 1px solid #eee;top: 0;box-shadow: 0px 0px 12px rgba(0,0,0,.175); z-index: 10000;">
    <h1 style="text-align: center; font-family: arvo; font-weight: 800; margin-bottom: 20px;"><a href="{{ route('user.dashboard') }}" style="color: #393333;">Gerenciamento de tarefas</a></h1>
    <ul class="nav navbar-stacked sidebar-inner">
        <li>
            <div class="media" style="padding-right: 15px;">
                ...
                <div class="media-body">
                    ...
                    <p><span class="glyphicon glyphicon-time" aria-hidden="true"></span> Member of history {{ Carbon\Carbon::parse(Auth::user()->created_at)->toFormattedDateString() }}</p>
                    <p><span class="glyphicon glyphicon-time" aria-hidden="true"></span> Member of history {{ verta(Auth::user()->created_at) }}</p>
                </div>
            </div>
        </li>
        <li>
            <form class="navbar-form" role="search" id="selet-board-form">
                ...
                <div class="form-group">
                    <select id="select-board">
                        <option value="">Choosing a board...</option>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-default" style="margin-bottom: 5px;">Escolha</button>
                </div>
            ...
            <form class="navbar-form" role="searchUser" id="select-user-form">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-default" style="margin-bottom: 5px;">Actions</button>
                </div>
            </form>
            @endif
        </li>
        ...
        <li style="padding-left: 15px; padding-right: 30px;">
            <a data-toggle="modal" href="#create-new-board" style="color: #393333;"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Creating a new board</a>
        </li>
        <hr>
        <li style="padding-left: 15px; padding-right: 30px;">
        ...
        <li style="padding-left: 15px; padding-right: 30px;">
            <a href="{{ route('users.index') }}"><span class="glyphicon glyphicon-user"></span>Manage Users</a>
        </li>
        <li style="padding-left: 15px; padding-right: 30px;">
            <a href="{{ route('roles.index') }}"><span class="glyphicon glyphicon-user"></span>Manage Role</a>
        </li>
        <li style="padding-left: 15px; padding-right: 30px;">
