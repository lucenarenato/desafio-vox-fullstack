                ...
                <form action="" method="POST" role="form" class="create-board-form">
                    ...
                    <div class="form-group" id="boardPrivacyTypeCon">
                        ...
                        <select name="boardPrivacyType" id="boardPrivacyType" class="form-control" required="required">
                            ...
                            <option value="public">Em geral</option>
                        </select>
                    </div>
                </form>
...
<div class="modal fade" id="edit-profile-info">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancelamento</button>
                <button type="button" class="btn btn-primary" id="save-change">Salvar alterações</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            <div role="tabpanel">
                <div class="modal-header" style="border-bottom: none; padding-bottom: 0px !important;">
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active">
                            <a href="#general" aria-controls="tab" role="tab" data-toggle="tab">Em geral</a>
                        </li>
                        <li role="presentation">
                            <a href="#date" aria-controls="tab" role="tab" data-toggle="tab">História</a>
                        </li>
                        <li role="presentation">
                            <a href="#subtasks" aria-controls="tab" role="tab" data-toggle="tab">Trabalhos relacionados e afiliados</a>
                        </li>
                        <li role="presentation">
                            <a href="#comments" aria-controls="tab" role="tab" data-toggle="tab">Comentárioا</a>
                        </li>
                    </ul>
                </div>
                <div class="modal-body" style="padding-top: 10px; padding-left: 35px; padding-right: 35px;">
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="general">
                            <form action="" method="POST" role="form">
                                ...
                                <div class="form-group" id="card-owner-div">
                                    <label for="">Card Manager</label>
                                    <select id="card-owner-select">
                                        <option value="">Escolhendo um gerente...</option>
                                        @if(isset($users))
                                        @foreach($users as $user)
                                        <option value="{{ $user['id'] }}">{{ $user["name"] }}</option>
                                        @endforeach
                        ...
                        <div role="tabpanel" class="tab-pane" id="subtasks">
                            To change the executor of any task, you must delete it and reassign it to someone else with the same title.
                            <div class="addSubTaskCon">
                                <h2>1Add a task as a subtask</h2>
                                <div class="input-group">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="save-change">Salvar alterações</button>
                    <button type="button" class="btn btn-danger" id="delete-card"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>Apagar</button>
                </div>
            </div>
        </div>
    </div>
