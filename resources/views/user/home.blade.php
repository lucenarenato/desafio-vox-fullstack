...
<div class="board-list-con" style="padding-left: 10px !important; padding-top: 40px !important; padding-right: 0px; padding-bottom: 0px;">
    <div class="my-fv-board">
        ...
        <div class="row boards-col">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6" data-boardid="{{ $board->id }}">
    ...
    <div class="my-board">
        ...
        <div class="row boards-col">
            ...
            <div class="col-lg-3" data-boardid="{{ $board->id }}">
                <div style="cursor: pointer;" data-boardid="{{ $board->id }}" class="{{$board->owner_id==Auth::id()?'board-admin':'board-link'}}">
                    <div class="row">
                        <div class="col-lg-10">
                            <h2 style="margin-top: 5px; text-align: left;">
                        ...
                        <div class="col-lg-2">
                            <p style="margin-top: 12px;">
                                <a href="#" style="font-size: 20px; {{ ($board->is_starred == 1) ? 'color:  ;' : 'color: #FFF;' }}" id="make-fv-board"><span class="glyphicon glyphicon-star" aria-hidden="true"></span></a>
                            </p>
                        </div>
                    </div>
        ...
        @empty
        <h2 class="board-create-head">
            Nenhum departamento foi definido para você.        </h2>
        @endforelse
    </div>
